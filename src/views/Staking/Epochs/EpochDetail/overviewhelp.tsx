export const commenthelper = {
  ...
  transaction:
    'The number of transactions in the block. Internal transaction is transactions as a result of contract execution that involves MGB value.',
  blockreward:
    'For each block, the miner is rewarded with a finite amount of MGB on top of the fees paid for all transactions in the block.',
  difficulty:
    'The amount of effort required to mine a new block. The difficulty algorithm may adjust according to time.',
  totaldifficult: 'Total difficulty of the chain until this block.',
  ...
  extra: 'Any data that can be included by the miner in the block.',
  Mgb: 'Closing price of MGB on date of transaction (Sep-04-2021)',
  hash: 'The hash of the block header of the current block.',
  parent: 'The hash of the block from which this block was generated, also known as its parent block.',
  sha: 'The mechanism which Mugambo Javascript RLP encodes an empty string.',
