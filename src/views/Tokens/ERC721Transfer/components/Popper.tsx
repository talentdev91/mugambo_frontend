              ...
              <Grid container>
                <Grid item xs={11} className={classes.main}>
                    ...
                    <Grid item>
                      ...
                      <Grid item>
                        <span className={classes.info}>
                          ...
                          <Link className={classes.link} href={`/tx/${row.rowInfo.token}`}>&nbsp;{row.rowInfo.token}</Link>
                        </span>
                        <span className={classes.info}>
                          From
                          <Link className={classes.link} href={`/tx/${row.rowInfo.from}`}>
                            <StyledTextOverflow1>&nbsp;{row.rowInfo.from}</StyledTextOverflow1>
                          </Link>
                          To
                          <Link className={classes.link} href={`/tx/${row.rowInfo.to}`}>
                  ...
                  <Grid item xs={12}>
                    ...
                    <Grid item>
                      <span className={classes.info}>
                        {row.rowInfo.gasused} Gas Used From {row.rowInfo.gas} Gas Limit @ {row.rowInfo.gasprice}  (
                  ...
                  <Grid item xs={12}>
                    ...
                    <Grid item>
                      <span className={classes.info}>
                        {row.rowInfo.nonce}
                        <span className={classes.info}>(in the position)</span>
                      </span>
                    </Grid>
                    <Divider className={classes.divider} />
                  </Grid>
